...
export default function CompetitionDetails({
  ...
  return (
    <>
      ...
      <section className={styles.section}>
        <h2 className={styles.sectionTitle}>{REGULATIONS_LABEL}</h2>
        {competition.regulationsUrl ? (
          <a
            className={styles.regulationsLink}
            href={competition.regulationsUrl}
            target="_blank"
            rel="noreferrer"
          >
            <svg
          ...
          <p className={styles.sectionNote}>{REGULATIONS_EMPTY_MESSAGE}</p>
        )}
      </section>
